...
class GetWorldData extends StatefulWidget {
  const GetWorldData({Key? key}) : super(key: key);

  @override
  State<GetWorldData> createState() => _GetMapDataState();
}

class _GetMapDataState extends State<GetWorldData> {
  ...
  Future<void> validateAndSubmit(BuildContext context) async {
    if (_formKey.currentState!.validate()) {
      ...
      //add validation
      Navigator.of(context).pushNamed(getWorldMapRoute,arguments: mapValues);
    }
  }
}